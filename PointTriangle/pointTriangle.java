...
public class pointTriangle {
    ...
    public boolean isRightAngle() {
        double[] var1 = new double[] { this.p1.distance(this.p2), this.p2.distance(this.p3),
    ...
    public boolean isConcurrent(pointTriangle var1) {
        double[] var2 = new double[] { this.p1.distance(this.p2), this.p2.distance(this.p3),
                this.p3.distance(this.p1) };
        double[] var3 = new double[] { var1.p1.distance(var1.p2), var1.p2.distance(var1.p3),
                var1.p3.distance(var1.p1) };
        Arrays.sort(var2);
        Arrays.sort(var3);
