...
public class Employee {
    ...
    public void increment(Employee other) {
        ...
        if (this.doh.getYear() == other.doh.getYear() && this.doh.getMonth() == other.doh.getMonth()
                && this.doh.getDate() == other.doh.getDate()) {
            checkDate(dob, other);
        }
        // if(this.dob.getYear() )
    ...
    public boolean equals(Employee other){
        ...
        return (this.name == other.name && 
                ...
                this.doh.getYear() == other.doh.getYear() 
                && this.doh.getMonth() == other.doh.getMonth()
                && this.doh.getDate() == other.doh.getDate() );
    }
    // public boolean hashCode(){
    //     return Objects.hash(name,salary,designation);
    // }
    // display
    public void display() {
