class Car{
    ...
    private float fuelTankCapacity;
        ...
        public void direction(String move){
            if(move == "left") this.direction =180;
            else if(move == "right") this.direction =0;
            else if(move == "forward") this.direction =90;
            else if(move == "reverse") this.direction =270;
        }
        // display
        public void display(){
            System.out.println( "key status --> "+key + "\n" +"speed --> "+ speed +  "\n" +"fuel -->"+ fuelTankCapacity + "\n" + "distance covered -->" + distance +" km"+"\n" + "direction --> " + direction + " degree turn");
        }
}
